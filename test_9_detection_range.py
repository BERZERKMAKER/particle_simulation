...
def wall_repulsive_force(particle_pos, wall_rect, k_rep=8000.0, influence_dist=50.0):
...
def check_collision_with_obstacles(particle, edge_obstacles, restitution=0.6):
